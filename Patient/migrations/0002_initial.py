    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateSuppression_debut', models.DateField(default=datetime.datetime(2023, 6, 1, 19, 18, 52))),
                ('dateSuppression_fin', models.DateField(default=datetime.datetime(2023, 7, 1, 20, 18, 52))),
            ],
        ),
        migrations.CreateModel(
            name='InfoPatient',
